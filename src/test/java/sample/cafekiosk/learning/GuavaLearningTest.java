...
public class GuavaLearningTest {
    ...
    @DisplayName("주어진 개수만큼 List를 파티셔닝한다.") // 파티셔닝 : 쪼개겠다.
    @Test
    ...
    @Test
    public void multimapLearningTest() throws Exception {
        // given
        Multimap<String, String> multimap = ArrayListMultimap.create(); // multimap: 일반적인 map은 하나의 key에 하나의 값만 넣을 수 있지만, multimap 은 하나의 key에 여러개의 value를 넣을 수 있다.
    ...
    @DisplayName("멀티맵 기능 확인")
    @TestFactory
    public Collection<DynamicTest> multimapLearningTest2() throws Exception {
        // given
